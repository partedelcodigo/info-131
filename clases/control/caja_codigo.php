...
class CAJA_CODIGO extends CONTROL {

    function cargar_parametros($mensaje, $nombre, $cant_caracteres, $tamano, $permiso, $exp_regular, $clase_css, $tip) {
        $this->nombre = $nombre;
    ...
    function dibujar() {
        $mensaje = ($this->permiso == 2) ? 'readonly' : '';
        echo $this->mensaje;
        echo '<input type="password" ' . $mensaje . ' class="' .
        $this->clase_css . '" name="' .
        $this->nombre . '" size="' .
